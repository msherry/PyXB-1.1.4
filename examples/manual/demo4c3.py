...
pyxb_114.utils.domutils.BindingDOMSupport.DeclareNamespace(address.Namespace, 'addr')
pyxb_114.utils.domutils.BindingDOMSupport.DeclareNamespace(po4.Namespace, 'po')
