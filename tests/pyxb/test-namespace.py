import unittest
import pyxb_114
from pyxb_114.namespace import ExpandedName
import xml.dom
from pyxb_114.namespace import XMLSchema as xsd
xsd.validateComponentModel()
import pyxb_114.binding.datatypes as xsd_module
...
class TestExpandedName (unittest.TestCase):
    ...
    def testConstructor (self):
        ...
        dom = pyxb_114.utils.domutils.StringToDOM('<ns1:%s xmlns:ns1="%s" attr="52">content</ns1:%s>' % (ln, ns_uri, ln))
        en = ExpandedName(dom.documentElement)
        ns = pyxb_114.namespace.NamespaceForURI(ns_uri)
        ...
        self.assertRaises(pyxb_114.LogicError, ExpandedName, child)
    ...
    def testAbsent (self):
        an = pyxb_114.namespace.CreateAbsentNamespace()
        an2 = pyxb_114.namespace.CreateAbsentNamespace()
    ...
    def testCategoryDeferral (self):
        int_en = pyxb_114.namespace.ExpandedName(xsd, 'int')
        self.assertEqual(xsd_module.int, int_en.typeBinding())
        self.assertRaises(pyxb_114.NamespaceError, getattr, int_en, 'notACategory')
...
class TestCategories (unittest.TestCase):
    ...
    def testNoCategory (self):
        self.assertRaises(pyxb_114.NamespaceError, pyxb_114.namespace.XMLSchema.categoryMap, 'not a category')
