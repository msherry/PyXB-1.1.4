...
class TestXSIType (unittest.TestCase):
    def testFailsNoType (self):
        ...
        self.assertRaises(pyxb_114.AbstractInstantiationError, CreateFromDOM, doc.documentElement)
    ...
    def testConstructor (self):
        ...
        self.assertRaises(pyxb_114.AbstractInstantiationError, originalOneFloor, **kw)
