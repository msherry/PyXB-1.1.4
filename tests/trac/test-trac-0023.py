...
class TestTrac0023 (unittest.TestCase):
    def testBasic (self):
        ...
        self.assertEqual(pyxb_114.binding.xml_.STD_ANON_space, structure._AttributeMap[pyxb_114.namespace.XML.createExpandedName('space')].dataType())
        ...
        self.assertEqual(pyxb_114.binding.datatypes.ID, structure._AttributeMap[pyxb_114.namespace.XML.createExpandedName('id')].dataType())
