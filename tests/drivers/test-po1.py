...
Anytown, AS  12345-6789'''
    ...
    def testPurchaseOrder (self):
        ...
        self.assertTrue((not isinstance(loc, pyxb_114.utils.utility.Locatable_mixin)) or (58 == loc.columnNumber))
        loc = po2.billTo.name._location()
        self.assertTrue((not isinstance(loc, pyxb_114.utils.utility.Locatable_mixin)) or (131 == loc.columnNumber))
    ...
    def testGenerationValidation (self):
        ...
        self.assertTrue(pyxb_114.RequireValidWhenGenerating())
        self.assertRaises(pyxb_114.DOMGenerationError, po.toxml)
        try:
            pyxb_114.RequireValidWhenGenerating(False)
            self.assertFalse(pyxb_114.RequireValidWhenGenerating())
            ...
            pyxb_114.RequireValidWhenGenerating(True)
        self.assertRaises(pyxb_114.UnrecognizedContentError, CreateFromDocument, xmls)
        self.assertTrue(pyxb_114.RequireValidWhenParsing())
        try:
            pyxb_114.RequireValidWhenParsing(False)
            self.assertFalse(pyxb_114.RequireValidWhenParsing())
